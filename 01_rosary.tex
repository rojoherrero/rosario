...
\begin{longtable} { p{0.475\textwidth} p{0.475\textwidth} }
      ...
      \response{Como era en el principio, ahora, y siempre, y por los siglos de los siglos. Amén}
            & 
      \response{Sicut erat in princípio et nunc, et semper et in sæcula sæculórum, Amen}\\\\
...
\end{flushright}
\bigredletter{Y}{}habiendo entrado a ella, dijo: «Dios te salve, llena de gracia, el Señor es contigo, bendita tu entre las mujeres». Ella, al oír estas palabras, se turbó, 
...
\end{flushright}
\bigredletter{Y}{} sdió a luz su hijo primogénito, y le envolvió en pañales y le recostó en un pesebre, pues no había para ellos lugar en el mesón. 
...
\end{flushright}
\bigredletter{Y}{} lleva consigo a Pedro y a Santiago y a Juan, y comenzó a sentir espanto y abatimiento; y le dice: «triste en gran manera está mi corazón hasta la muerte; 
...
\end{flushright}
\bigredletter{«Y}{o} no hallo en Él delito alguno. Es costumbre vuestra que yo os suelte un preso por la Pascua: ¿queréis, pues, que os suelte al rey de los Judíos?». 
