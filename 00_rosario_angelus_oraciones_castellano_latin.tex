...
\end{flushright}
\primeraletragranderoja{Y}{}habiendo entrado a ella, dijo: \comillas{Dios te salve, llena de gracia, el Señor es contigo, bendita tu entre las mujeres}. Ella, al oír estas palabras, se turbó,
y discurría que podría ser esta salutación. Y le dijo el ángel: \comillas{No temas, María, pues hallaste gracia a los ojos de Dios. He aquí que concebirás en tu seno y darás a luz un Hijo,
...
Y les dijo el Ángel: \comillas{No temáis, pues he aquí que os traigo una buena nueva, que será de grande alegría para todo el pueblo: 
...
Y sus padres, al verle, quedaron sorprendidos; y le dijo su madre: \comillas{Hijo, ¿por qué lo hiciste así con nosotros? Mira que tu padre y yo, llenos de aflicción, 
...
\comillas{Tú eres mi Hijo amado, en Ti me agradé}.
...
\end{flushright}
\primeraletragranderoja{Y}{} lleva consigo a Pedro y a Santiago y a Juan, y comenzó a sentir espanto y abatimiento; y le dice: \comillas{triste en gran manera está mi corazón hasta la muerte;
quedad aquí y velad}. Y apartándose un poco, caía sobre tierra, y rogaba que, a ser posible, pasase el Él aquella hora, y decía: \comillas{Abba, Padre, todas las cosas te son posibles:
...
Gritaron, pues, de nuevo, diciendo: \comillas{No, a ése, sino a Barrabás}.Era este Barrabás un salteador. Entonces, pues, tomó Pilato a Jesús y le azotó.
...
\begin{minipage}[t]{0.475\textwidth}
      \versiculorespuesta{El Ángel del Señor anunció a María}{Y ella concibió por obra y gracia del Espíritu Santo}\\\\
      \textbf{Oremos}
...
\lineaverticalroja{1}
\begin{minipage}[t]{0.475\textwidth}
      \versiculorespuesta{Regina caeli l{\ae}táre, allelúia}{Quia quem meruisti portáre, allelúia}\\
      \versiculorespuesta{Resurréxit sicut dixit, allelúia}{Ora pro nobis Deum, allelúia}\\
...
\smallskip
\begin{minipage}[t]{0.475\textwidth}
      \input{oraciones/credo_apostoles_castellano.tex}\\

      \input{oraciones/san_jose_castellano.tex}\\
