...
\begin{document}
    ...
    \begin{tabular} { p{0.5\textwidth} p{0.5\textwidth} }
        ...
        \textbf{Alegraos y regocijaos, Virgen María, aleluya.} & \textbf{Gaudate el laetáre, Virgo María, allelúia.}\\
        \textit{Porque resucitó verdaderamente el Señor, aleluya}. & \textit{Quia surréxit Dóminus vere, allelúia.}\\
