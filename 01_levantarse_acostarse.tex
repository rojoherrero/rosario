...
\begin{multicols}{2}
      ...
      \begin{otherlanguage}{latin}
            ...
            \input{oraciones/credo/apostoles_latin_sencillo.tex}
      ...
      \input{oraciones/angel_guarda/latin_dia.tex}
      ...
      \begin{otherlanguage*}{latin}
            \input{oraciones/regina_coelis/latin_sencillo.tex}
            
            \lineahorizontalroja{3}{0.5}

            \input{oraciones/san_miguel/latin_sencillo.tex}
      \end{otherlanguage*}
...
\begin{multicols}{2}
      ...
      \input{oraciones/angel_guarda/latin_noche.tex}
